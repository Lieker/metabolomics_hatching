...
```{r, eval = F}
source("scripts/correlationlist.R")
corr_solA_p_extract <- correlationlist(x = t(extract_pos_f), interest = "solA")
corr_solA_n_extract <- correlationlist(x = t(extract_neg_f), interest = "solA")

#Also do this for hatching, since we need it for suppl Table 1
corr_hatching_p_extract <- correlationlist(x = t(extract_pos_f), interest = "hatching")
corr_hatching_n_extract <- correlationlist(x = t(extract_neg_f), interest = "hatching")
```

```{r}
corr_solA_p_extract <- read.csv("output/corr_solA_p_extract.csv", header = TRUE, fileEncoding = "UTF-8-BOM")
corr_solA_n_extract <- read.csv("output/corr_solA_n_extract.csv", header = TRUE, fileEncoding = "UTF-8-BOM")
