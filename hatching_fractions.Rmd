...
pn <- ggplot(fr_n_subset, aes(x = fraction, y = value)) +
  ...
  ylab("counts") +
  scale_colour_discrete(name = "feature", labels = c("m/z 497.18, Rt 6.70", "m/z 525.18, Rt 7.32")) +
...
fr_subset$label <- c(rep("m/z 497.18 (-), Rt 6.70", 12), rep("m/z 525.18 (-), Rt 7.32", 12), rep("m/z 499.20 (+), Rt 6.69", 12))
